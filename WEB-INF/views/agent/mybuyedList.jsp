...
<div>
    <table class="easyui-datagrid" style="width:1120px;height:auto">
        ...
        <tr>
            ...
            <th data-options="field:'serId',width:120">购钻时间</th>
...
<script type="text/javascript">
    function changePage(pageNum) {
        ...
        window.location.href="/agent/my/buyed?pageNum="+pageNum+"&pageSize="+ pageSize;
    }
    function changePageSize(obj) {
        var pageSize = obj.selectedOptions[0].value
        window.location.href="/agent/my/buyed?pageNum="+0+"&pageSize="+ pageSize;
    }
</script>
